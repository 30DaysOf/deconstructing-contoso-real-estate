...
template: splash
hero:
  tagline: Want to build an enterprise-grade solution on Azure? Start by tearing one down! Deconstruct our open-source reference implementation!
  image:
    file: ../../assets/img/contoso-logo.svg
  actions:
    - text: Explore The Labs
      link: ./1-introduction/1-motivation/
      icon: open-book
      variant: primary
